...
if (event.member.roles.includes(cwsRole || adminRole) || event.member.user.id === retrieve_guild.owner_id || event.permission_names.includes('ADMINISTRATOR')) {
  
  await helpers.ban(event, reason, staff, user_id, staff_id)
}
